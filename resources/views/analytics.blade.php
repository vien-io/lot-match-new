...
<div class="tw-flex tw-flex-col tw-gap-6 tw-p-6 tw-bg-gray-50 min-h-screen">
    ...
    <div class="tw-flex tw-flex-wrap tw-gap-4">
        ...
        <div class="tw-bg-white tw-rounded-2xl tw-shadow-md tw-p-4 tw-flex-1 tw-min-w-[200px]">
            ...
            <p class="tw-text-gray-500">Price: ₱{{ number_format($lot->price, 2) }}</p>
            <p class="tw-text-yellow-400">Rating: {!! str_repeat('★', round($lot->avg_rating)) !!}{!! str_repeat('☆', 5 - round($lot->avg_rating)) !!}</p>
        </div>
        @endforeach
    </div>

    {{-- Row: Recent Reviews & Lot Availability --}}
    <div class="tw-grid tw-grid-cols-1 lg:tw-grid-cols-2 tw-gap-6">
