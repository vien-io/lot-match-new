...
<body class="tw-bg-gray-50">
    <div id="app" class="tw-flex tw-h-screen">
        ...
        <div 
            ...
            class="sidebar tw-bg-white tw-shadow-lg tw-w-20 tw-flex tw-flex-shrink-0 tw-flex-col tw-items-center tw-py-6 tw-sticky tw-top-0 tw-h-screen tw-transition-shadow tw-duration-300 tw-z-50"
        >
