...
<div id="editUserModal" class="tw-hidden tw-fixed tw-inset-0 tw-bg-black/50 tw-flex tw-items-center tw-justify-center tw-z-50">
  <div class="tw-bg-white tw-rounded-2xl tw-shadow-lg tw-w-full sm:tw-w-[400px] tw-p-6">
    ...
    <form id="editUserForm" method="POST">
      ...
      <div class="tw-mb-3">
        <label class="tw-block tw-font-medium">First Name</label>
        <input type="text" id="editFirstName" name="first_name" class="tw-w-full tw-border tw-rounded tw-p-2" required>
      </div>
      <div class="tw-mb-3">
        <label class="tw-block tw-font-medium">Last Name</label>
        <input type="text" id="editLastName" name="last_name" class="tw-w-full tw-border tw-rounded tw-p-2" required>
      </div>
      <div class="tw-mb-3">
